...
//        usleep(1)
    ...
    func addIndicator(){
//        indicator = UIActivityIndicatorView(frame: CGRect(0, 0, 50, 50)) as UIActivityIndicatorView
        //  indicator.hidesWhenStopped = true
        indicator.center = self.window!.center
        indicator.frame = CGRect(x: UIScreen.main.bounds.width/2 - 25, y: UIScreen.main.bounds.height/2 - 25, width: 50, height: 50)
...
//        }
    ...
    func navigateToIntro() {
        DispatchQueue.main.async(execute: {
            ...
            let splashVC = storyboard.instantiateViewController(withIdentifier: "SplashScreenVC")
