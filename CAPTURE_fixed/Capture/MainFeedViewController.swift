...
//        }
        ...
        postCounter.isHidden = true
        postCounter.layer.masksToBounds = true
        postCounter.layer.cornerRadius = 5
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        postCounter.isHidden = false
        postCounter.text = String(posts.count)
    }
