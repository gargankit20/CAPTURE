...
//        let headerView = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionElementKindSectionHeader, withReuseIdentifier: "meHeaderView", for: indexPath) as! MeHeaderCollectionReusableView

//        let MeHeaderView: MeHeaderCollectionReusableView
//        let nib = UINib(nibName: "meHeaderView", bundle:nil)
//        self.collectionView?.registerNib(nib, forCellWithReuseIdentifier: "header_view_id")
//        
//        _templateHeader = nib.instantiateWithOwner(nil, options:nil)[0] as! MeHeaderCollectionReusableView
