...
class SearchViewController: UIViewController, ExplorerPostsDelegate, ExplorerPeopleDelegate, ExplorerTagsDelegate, ExplorerHeaderTagsDelegate, ViewAllPostDelegate {
    ...
    func goViewAll() {
        performSegue(withIdentifier: "ShowAllPost", sender: nil)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        } else if segue.identifier == "ShowAllPost" {
            let vc = segue.destination as! AllPostViewController
//            if let id = idToPass {
//                vc.userId = id
//            } else {
//                return
